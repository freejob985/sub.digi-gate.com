...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::group(['prefix' => 'website'], function(){
		...
		Route::view('/header', 'admin.default.website.header')->name('website.header');
		Route::view('/footer', 'admin.default.website.footer')->name('website.footer');
		Route::view('/pages', 'admin.default.website.pages')->name('website.pages');
		Route::view('/appearance', 'admin.default.website.appearance')->name('website.appearance');
