<header class="aiz-header @if(get_setting('header_stikcy') == 'on') sticky-top @endif" style="background:#d65e2c!important;">
    <div class="aiz-navbar py-15px fs-14 position-relative">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="{{ route('home') }}" class="d-inline-block">
                        <img style="margin-left:44px;"
                    src="{{ custom_asset(get_setting('header_logo')) }}" height="32">
                    </a>
                    <a class="menu-a"  href="http://sub.digi-gate.com/search?keyword=&type=freelancer">{{ translate('Freelancers') }}</a>
                      <a class="menu-a" href="http://sub.digi-gate.com/search?keyword=&type=project">{{ translate('Projects') }}</a>
                        <a class="menu-a" href="http://sub.digi-gate.com/search?keyword=&type=service">{{ translate('Services') }}</a>
                </div>
                        ...
                        <form action="{{ route('search') }}" method="GET" class="flex-grow-1">
                            <div class="input-group">
                                ...
                                <div class="input-group-prepend flex-grow-1 d-none d-sm-block">
                                    <input type="text" class="form-control" placeholder="أبحث عن" name="keyword">
                                </div>
                ...
                <div class="menu">
                    <nav class="navbar-expand">
                        <ul class="navbar-nav ml-auto align-items-center">
                            ...
                            @else
                                <li class="nav-item ml-xl-3">
                                    <a class="btn btn-primary" href="{{ route('admin.dashboard') }}">{{ translate('My Panel') }}</a>
                                </li>
                            @endif
                        </ul>
                    </nav>
