...
class CancelProjectController extends Controller
{
    ...
    {
        if (Gate::allows('cancel_project_request_list')) {
            $client_id = null;
            ...
            return view('admin.default.project_cancel_request.request_lists', compact('cancel_projects', 'client_id'));
        }
        else {
    ...
    public function show(Request $request)
    {
        if (Gate::allows('cancel_project_request_show')) {
            ...
            $cancel_project->save();
            return view('admin.default.project_cancel_request.request_details_modal', compact('cancel_project'));
        }
        else {
            flash('You do not have access permission')->error();
            return back();
    ...
    public function destroy($id)
    {
        if (Gate::allows('cancel_project_request_delete')) {
            ...
            flash(__('Project Cancel Request has been deleted successfully'))->success();
            return redirect()->route('cancel-project-request.index');
        }
        else {
            flash('You do not have access permission')->error();
