...
class SupportCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('support_ticket.support_categories.index', compact('support_categories'));
    }
    ...
    public function edit($id)
    {
         ...
         return view('support_ticket.support_categories.edit', compact('support_category'));
    }
    /**
