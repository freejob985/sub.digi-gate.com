...
class PortfolioController extends Controller
{
    ...
    public function store(Request $request)
    {
        if(count(Auth::user()->userPortfolios) < Auth::user()->userPackage->portfolio_add_limit){
            ...
            flash(__('Sorry! Portfolio adding limit has been reached.'))->warning();
            return back();
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($portfolio->save()) {
            flash(__('Your Portfolio has been updated successfully'))->success();
            return redirect()->route('user.profile');
        }
        else {
    ...
    public function destroy(Request $request, $id){
        ...
        flash(__('Portfolio has been deleted successfully'))->success();
        return redirect()->route('user.profile');
    }
}
