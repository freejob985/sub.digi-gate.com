...
class WorkExperienceController extends Controller
{
    ...
    public function store(Request $request)
    {
        if(count(Auth::user()->workExperiences) < Auth::user()->userPackage->job_exp_limit){
            ...
            $work_exp->save();
            flash(__('New work experience has been added successfully'))->success();
            return redirect()->route('user.profile');
        }
        else {
            flash(__('Sorry! Work experience adding limit has been reached.'))->warning();
            return back();
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($work_exp->save()) {
            flash(__('Work Experience has been updated successfully'))->success();
            return redirect()->route('user.profile');
        }
        else {
    ...
    public function destroy(Request $request, $id){
        ...
        flash(__('Work Experience has been deleted successfully'))->success();
        return redirect()->route('user.profile');
    }
}
