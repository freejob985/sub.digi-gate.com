<form class="" action="{{ route('offline_milestone_payment_to_admin') }}" method="post">
    @csrf
    <input type="hidden" name="milestone_payment_id" value="{{$milestone_payment_id}}">
            ...
            <div class="col-6 col-md-4">
                <label class="aiz-megabox d-block mb-3">
                    ...
                    <span class="d-block p-3 aiz-megabox-elem">
                        <img src="{{ custom_asset($method->photo) }}" class="img-fluid mb-2">
        ...
        <div id="manual_payment_data">
            ...
            <div class="card mb-3 p-3">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label">{{ translate('Receipt') }}</label>
                    <div class="col-md-9">
