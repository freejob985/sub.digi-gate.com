					...
					<div class="sticky-top z-3">
						<div class="card project-card">
							<div class="card-header py-4">
                                ...
                                @elseif (Auth::check() && \App\Models\Role::find(Session::get('role_id')) == null)
                                    <div class="alert alert-info" role="alert">
                                        {{ translate('You are visit this details as Admin. For place a bid you need to have a freelancer account.') }}
                                    </div>
							...
							<div class="card-body">
								<div class="mb-5">
									<div class="d-flex justify-content-between mb-3">
										...
										<span class="fw-600" >{{ str_replace("होरा ","",Carbon\Carbon::parse($project->created_at)->diffForHumans()) }}</span>
									</div>
									<div class="d-flex justify-content-between mb-3">
