                        ...
                        <div class="card-body">
                            <div class="row gutters-10 mb-4">
                                <div class="col-md-6">
                                    <div class="alert alert-info mb-0">
                                        {{ translate('Your available balance is') }} {{ single_price($profile->balance) }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="alert alert-info mb-0">
                            ...
                            <form class="form-horizontal" action="{{ route('store_withdrawal_request_to_admin') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="amount" min="{{ \App\Models\SystemConfiguration::where('type', 'min_withdraw_amount')->first()->value }}" max="{{ $profile->balance }}" step="1" placeholder="Enter withdrawal amount" value="{{ $profile->balance }}" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">
