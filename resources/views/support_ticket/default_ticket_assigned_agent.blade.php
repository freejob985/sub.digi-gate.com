                    ...
                    <div class="card cta-box bg-danger text-white">
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <img class="ml-3" src="{{my_asset('assets/backend/default/img/email-campaign.svg')}}" width="120" alt="Generic placeholder image">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-sm-10">
                                ...
                                <select name="default_ticket_assigned_user" class="form-control aiz-selectpicker" data-live-search="true" required>
                                    @foreach($staffs as $staffs)
                                        <option value="{{$staffs->user_id}}" @if(get_setting('default_ticket_assigned_user') == $staffs->user_id) selected @endif>{{$staffs->user->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
